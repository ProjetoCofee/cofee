                    ...
                    <div class="panel-heading">Contas</div>
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><a href="/contas/despesas">Despesas<span class="sr-only">(current)</span></a>
                                <ul class="nav nav-pills nav-stacked"> 
                                    <li class="active" style = "padding-left: 10px"><a href="#"> <span class="glyphicon glyphicon-menu-right"></span>  Parcelas</a></li>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <div style="display: inline-flex; float: right;">
                                                ...
                                                <button title="Excluir parcela" type="submit" class="btn btn-icon remove" data-toggle="modal" data-target="#delete_item" onclick="delete_parcela('{{$parcela->num_parcela}}')"><span class="glyphicon glyphicon-trash"></span></button>
